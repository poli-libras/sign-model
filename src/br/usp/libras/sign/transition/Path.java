...
public enum Path {
    ...
    LINEAR, CIRCULAR_HORARIO_EM_XY, CIRCULAR_ANTI_HORARIO_EM_XY, CIRCULAR_HORARIO_EM_XZ, CIRCULAR_ANTI_HORARIO_EM_XZ, CIRCULAR_HORARIO_EM_YZ, CIRCULAR_ANTI_HORARIO_EM_YZ;
